...
(function() {
  ...
  var apiKey = "05e62f86576a85bc20cce0e46674216f"; // Replace "APIKEY" with your own API key; otherwise, your HTTP request will not work
  var activities = {
  ...
  function updateUISuccess(response) {
    ...
    */
    ...
    conditionsPara.textContent =
      state.degCInt + "\xB0 C / " + state.degFInt + "\xB0 F";
  ...
  function updateActivityList(event) {
    ...
    function updateState(type) {
      if (category === "solo") {
        ...
        (_state$activities = state.activities).push.apply(
          _state$activities,
          _toConsumableArray(activities["solo" + type])
        );
      } else if (category === "team") {
        var _state$activities2;

        (_state$activities2 = state.activities).push.apply(
          _state$activities2,
          _toConsumableArray(activities["team" + type])
        );
      } else {
        var _state$activities3, _state$activities4;

        (_state$activities3 = state.activities).push.apply(
          _state$activities3,
          _toConsumableArray(activities["solo" + type])
        );
        (_state$activities4 = state.activities).push.apply(
          _state$activities4,
          _toConsumableArray(activities["team" + type])
        );
      }
